...
const guardInitials = () => demoData.guard.name.split(' ').map((part) => part[0]).join('').slice(0, 2);
const communityLabel = () => `${demoData.guard.communityCode} · ${demoData.guard.community}`;
