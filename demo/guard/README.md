...
- QR de visitante válido, vencido e inválido.
- QR de credencial personal de residente.
- Registro manual con autorización ficticia aprobada o rechazada.
- Visitante dentro, salida y bitácora.
- Modo sin conexión, persistencia en `localStorage` y conciliación simulada al volver en línea.
...
```html
<iframe
  src="https://elipsoftdev.github.io/NOCTAweb/demo/guard/"
